package com.patbaumgartner.embabel.ticket.triage.agent;

import com.embabel.agent.api.annotation.AchievesGoal;
import com.embabel.agent.api.annotation.Action;
import com.embabel.agent.api.annotation.Agent;
import com.embabel.agent.api.common.OperationContext;
import com.patbaumgartner.embabel.ticket.triage.domain.TriageModels.*;
...
public class TicketTriageAgent {
	...
	// Normal path: we can classify confidently right away (heuristic, deterministic)
	@Action
	...
	// Replanning path: intentionally returns an uncertain result (forces deepClassify)
	@Action
	...
	public ConfidentCategory deepClassify(UncertainCategory u, Signals s, OperationContext context, TraceLog trace) {
		...
		LlmCategory llm = context.ai().withDefaultLlm().createObject(prompt, LlmCategory.class);
	...
	public PriorityAssessment assessPriority(ConfidentCategory category, Signals s, OperationContext context,
		...
		LlmPriority llm = context.ai().withDefaultLlm().createObject(prompt, LlmPriority.class);
